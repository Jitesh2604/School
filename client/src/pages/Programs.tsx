...
const programs = [
  {
    ...
    benefits: ["Sensory exploration activities", "Basic motor skill development", "Social interaction and sharing", "Music & movement sessions", "Parent-teacher bonding"],
  },
  {
    id: "nursery",
    title: "Nursery",
    ...
    benefits: ["Language and vocabulary building", "Creative arts and storytelling", "Introduction to numbers & shapes", "Outdoor play and fitness", "Emotional regulation skills"],
  },
  {
    id: "junior-kg",
    ...
    benefits: ["Phonics and early reading", "Mathematical reasoning", "Science exploration projects", "Team activities and leadership", "Cultural awareness programs"],
  },
  {
    id: "senior-kg",
        ...
        <div className="space-y-12">
          {programs.map((p, i) => (
            <ScrollReveal key={p.id} delay={i * 60}>
              <div id={p.id} className={`pastel-card border-2 ${p.borderColor} scroll-mt-24`}>
                <div className="grid md:grid-cols-5 gap-8">
                  <div className="md:col-span-3">
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`w-10 h-10 ${p.color} rounded-xl flex items-center justify-center`}>
                        <span className="font-display font-bold text-foreground/60">{i + 1}</span>
                      </div>
                      <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed text-pretty">{p.desc}</p>
                  </div>
                  <div className="md:col-span-2">
                    <h4 className="font-display font-bold text-sm uppercase tracking-wider text-muted-foreground mb-3">Key Benefits</h4>
